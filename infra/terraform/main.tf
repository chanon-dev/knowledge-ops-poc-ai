terraform {
  ...
  backend "s3" {
    bucket         = "the-expert-terraform-state"
...
resource "aws_rds_cluster" "main" {
  ...
  engine_version     = "16.1"
  database_name      = "the_expert"
  master_username    = "expert"
...
resource "aws_s3_bucket" "knowledge" {
  bucket = "${local.name_prefix}-knowledge-docs"
  tags   = { Name = "${local.name_prefix}-knowledge" }
}
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "DATABASE_URL", value = "postgresql+asyncpg://expert:${var.db_password}@${aws_rds_cluster.main.endpoint}:5432/the_expert" },
